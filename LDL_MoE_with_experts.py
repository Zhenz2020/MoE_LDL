...
class KLDivergenceLoss(Loss):
    ...
    def kl_divergence(self, mu1, sigma1, mu2, sigma2, lambda_):
    ...
    def call(self, y_true, y_pred):
        kl_loss = tf.reduce_mean(self.kl_divergence(mu1=y_true, sigma1=1.0, mu2=y_pred, sigma2=1.0, lambda_=0.001))
        return kl_loss
...
class KLDivergenceLoss_mixture(Loss):
